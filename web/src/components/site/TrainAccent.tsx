...
/** Soft centered train — static; one short glide only on Rejsy brand hover/tap. */
export function TrainAccent() {
  ...
  return (
    ...
    >
      ...
      >
        <div
          className={playing ? "train-glide-play" : undefined}
          onAnimationEnd={onGlideEnd}
        >
          <div className="opacity-[0.13] sm:opacity-[0.15] md:opacity-[0.17]">
            <Image
              src="/train-hero.webp"
              alt=""
              width={1600}
