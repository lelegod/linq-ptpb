export const copy = {
  ...
  loginSub:
    "For existing accounts. New here? Join the waitlist — no Google setup required.",
  waitlistWelcome: "Welcome to Rejsy",
  waitlistDetailsTitle: "Join the waitlist",
  waitlistDetailsSub:
    "Two quick details — we’ll save you a spot before public launch.",
  waitlistEmailTitle: "Where should we write you?",
  waitlistEmailSub: "We’ll only email when there’s news worth opening.",
  waitlistContinue: "Continue",
  waitlistJoin: "Join the waitlist",
  waitlistLater: "Maybe later",
  waitlistSuccessTitle: "You're on the list",
  waitlistSuccess: "You're on the list.",
  waitlistSuccessSub: "Thanks for riding with us early.",
  // Legacy onboarding strings (login / dashboard leftovers)
